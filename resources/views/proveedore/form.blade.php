<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('dias_visita') }}
            {{ Form::text('dias_visita', $proveedore->dias_visita, ['class' => 'form-control' . ($errors->has('dias_visita') ? ' is-invalid' : ''), 'placeholder' => 'Dias Visita']) }}
            {!! $errors->first('dias_visita', '<div class="invalid-feedback">:message</div>') !!}
        </div>
